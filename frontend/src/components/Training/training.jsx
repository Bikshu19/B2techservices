  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-cyan-50 overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
        ...
        >
          {/* Floating Badge */}
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-200 mb-8 animate-bounce">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="relative p-12 rounded-3xl overflow-hidden shadow-2xl" style={{ backgroundColor: '#00809D' }}>
            ...
            <div className="relative z-10 text-center text-white">
              ...
              {/* Contact Card */}
              <div className="inline-flex items-center gap-4 px-8 py-4 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20">
                <Mail className="w-6 h-6" />
                <div className="text-left">
                  <p className="text-sm opacity-80">Interested in our training programs?</p>
                  <a href="mailto:hrushikesh@b2techservices.in" className="font-semibold hover:underline">
