    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md mb-6 border border-cyan-100">
      ...
      <div id="contact" className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-gradient-to-br from-[#0a1f44] via-[#00809D] to-cyan-600 rounded-3xl p-12 shadow-2xl text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a href="mailto:hrushikesh@b2techservices.in" className="group flex items-center gap-3 bg-white text-[#0a1f44] px-8 py-4 rounded-2xl font-semibold shadow-lg hover:shadow-2xl transition-all hover:scale-105">
              <Mail className="w-5 h-5 text-[#00809D]" />
              hrushikesh@b2techservices.in
            </a>
            
            <a href="https://wa.me/916364053221" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 bg-green-500 text-white px-8 py-4 rounded-2xl font-semibold shadow-lg hover:shadow-2xl transition-all hover:scale-105 hover:bg-green-600">
