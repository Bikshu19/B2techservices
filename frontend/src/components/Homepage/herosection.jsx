...
function Herosection() {
  const stats = [
    { number: 48, label: "Professional Staff", icon: <Users className="w-8 h-8 text-blue-500 mx-auto mb-3" /> },
    { number: 24, label: "Years of Experience", icon: <Award className="w-8 h-8 text-purple-500 mx-auto mb-3" /> },
    { number: 3578, label: "Satisfied Clients", icon: <Smile className="w-8 h-8 text-pink-500 mx-auto mb-3" /> },
  ];
            ...
            {stats.map((stat, i) => (
              ...
              >
                ...
                <div className="relative bg-white-10 rounded-full shadow-2xl px-8 py-6 text-center flex flex-col items-center">
                  ...
                  <p className="text-[#00809D]-900 text-sm mt-2">{stat.label}</p>
                </div>
              </motion.div>
            ))}
          </div>
